...
public class Consumer extends Entity {
    ...
    private String service; /* The name of the com.ch.commoninterface.service referenced by the consumer */
    ...
    public String toString() {
        return "Consumer [com.ch.commoninterface.service=" + service + ", parameters=" + parameters + ", result=" + result
