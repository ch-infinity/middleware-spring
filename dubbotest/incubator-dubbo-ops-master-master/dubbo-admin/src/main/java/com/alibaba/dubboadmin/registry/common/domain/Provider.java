...
public class Provider extends Entity {
    ...
    private String service;/* The name of the com.ch.commoninterface.service provided by the provider */

    private String url; /* Provider's address for com.ch.commoninterface.service */

    private String parameters; /* Provider provides com.ch.commoninterface.service parameters */
