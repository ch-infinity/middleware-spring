...
public class ConfigServiceImpl extends AbstractService implements ConfigService {
    ...
    /* (non-Javadoc)
     * @see com.alibaba.dubbo.governance.com.ch.commoninterface.service.ConfigService#update(java.util.List)
     */
    ...
    /* (non-Javadoc)
     * @see com.alibaba.dubbo.governance.com.ch.commoninterface.service.ConfigService#findAllConfigsMap()
     */
