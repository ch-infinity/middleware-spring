 ...
 * <br>
 * GET /services/$com.ch.commoninterface.service/providers, show all provider of a specific com.ch.commoninterface.service<br>
 * GET /services/$com.ch.commoninterface.service/providers/add, show web form for add a static provider<br>
 * POST /services/$com.ch.commoninterface.service/providers, save a static provider<br>
 * GET /services/$com.ch.commoninterface.service/providers/$id, show provider details<br>
 * GET /services/$com.ch.commoninterface.service/providers/$id/edit, show web form for edit provider<br>
 * POST /services/$com.ch.commoninterface.service/providers/$id, save changes of provider<br>
 * GET /services/$com.ch.commoninterface.service/providers/$id/delete, delete provider<br>
 * GET /services/$com.ch.commoninterface.service/providers/$id/tostatic, transfer to static<br>
 * GET /services/$com.ch.commoninterface.service/providers/$id/todynamic, transfer to dynamic<br>
 * GET /services/$com.ch.commoninterface.service/providers/$id/enable, enable<br>
 * GET /services/$com.ch.commoninterface.service/providers/$id/disable, diable<br>
 * GET /services/$com.ch.commoninterface.service/providers/$id/reconnect, reconnect<br>
 * GET /services/$com.ch.commoninterface.service/providers/$id/recover, recover<br>
 */
@Controller
...
public class ProvidersController extends BaseController {
    ...
    public String index(HttpServletRequest request, HttpServletResponse response, Model model) {
        ...
        String service = (String) newModel.get("com.ch.commoninterface.service");
    ...
    /**
     * Calculate the application list corresponding to each com.ch.commoninterface.service, to facilitate the "repeat" prompt on com.ch.commoninterface.service page
     *
    ...
    /**
     * Load new com.ch.commoninterface.service page, get all the com.ch.commoninterface.service name
     */
    ...
    public String create(@ModelAttribute Provider provider, HttpServletRequest request, HttpServletResponse response, Model model) {
        ...
        String service = provider.getService();
        if (service == null) {
            service = (String) ((BindingAwareModelMap) model).get("com.ch.commoninterface.service");
