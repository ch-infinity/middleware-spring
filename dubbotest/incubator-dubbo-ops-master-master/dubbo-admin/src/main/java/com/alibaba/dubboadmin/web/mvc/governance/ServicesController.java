...
/**
 * ProvidersController. URI: /services/$com.ch.commoninterface.service/providers /addresses/$address/services /application/$application/services
 */
@Controller
...
public class ServicesController extends BaseController {
    ...
    private String mock(Long[] ids, String mock, String methodName, HttpServletRequest request,
        ...
        BindingAwareModelMap newModel = (BindingAwareModelMap) model;
        String services = (String) newModel.get("com.ch.commoninterface.service");
        String application = (String) newModel.get("app");
