...
public class RouterController {
    ...
    // com.ch.commoninterface.service mapping
    ...
    public String appRouter(@PathVariable("app") String app, @PathVariable("elements") String elements,
        ...
        if (StringUtils.isNumeric(element)) {
            //com.ch.commoninterface.service action, shield, recover..
            Long[] ids = new Long[1];
            ids[0] = Long.valueOf(element);
            model.addAttribute("service", request.getParameter("com.ch.commoninterface.service"));
            try {
