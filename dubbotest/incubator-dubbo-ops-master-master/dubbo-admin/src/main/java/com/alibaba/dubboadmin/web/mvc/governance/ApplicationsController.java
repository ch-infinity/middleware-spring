...
public class ApplicationsController extends BaseController {
    ...
    //public void search(@RequestParam(required = false) String com.ch.commoninterface.service,
    //                   @RequestParam(required = false) String address,
    //                   @RequestParam(required = false) String application,
    //                   @RequestParam(required = false) String keyword,
    //                   HttpServletRequest request, HttpServletResponse response, Model model) {
    //    index(com.ch.commoninterface.service, address, application, keyword, request, response, model);
    //
    //    //Set<String> newList = new HashSet<String>();
