...
/**
 * ProvidersController.
 * URI: /services/$com.ch.commoninterface.service/routes
 */
@Controller
...
public class RoutesController extends BaseController {
    ...
    static void checkService(String service) {
        if (service.contains(",")) throw new IllegalStateException("com.ch.commoninterface.service(" + service + ") contain illegale ','");
        ...
        if (interfaceName.indexOf('*') != -1 && interfaceName.indexOf('*') != interfaceName.length() - 1) {
            throw new IllegalStateException("com.ch.commoninterface.service(" + service + ") only allow 1 *, and must be last char!");
        }
    }

    /**
     * add owners related with com.ch.commoninterface.service
     *
    ...
    /**
     * add owners related with com.ch.commoninterface.service pattern
     *
     * @param usernames          the usernames to add
     * @param serviceNamePattern com.ch.commoninterface.service pattern, Glob
     */
    ...
    public String create(HttpServletRequest request, HttpServletResponse response, Model model) {
        ...
        String service = request.getParameter("com.ch.commoninterface.service");
    ...
    public void preview(Map<String, Object> context) throws Exception {
        ...
        if (StringUtils.isNotEmpty(consumerid)) {
            ...
            String service = (String) context.get("com.ch.commoninterface.service");
