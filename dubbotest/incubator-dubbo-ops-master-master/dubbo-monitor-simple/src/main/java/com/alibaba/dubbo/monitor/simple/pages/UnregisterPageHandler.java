...
public class UnregisterPageHandler implements PageHandler {
    ...
    public Page handle(URL url) {
        ...
        String parameter;
        if (url.hasParameter("com.ch.commoninterface.service")) {
            parameter = "com.ch.commoninterface.service=" + url.getParameter("com.ch.commoninterface.service");
            ...
            parameter = "com.ch.commoninterface.service=" + providerUrl.getServiceInterface();
        }
