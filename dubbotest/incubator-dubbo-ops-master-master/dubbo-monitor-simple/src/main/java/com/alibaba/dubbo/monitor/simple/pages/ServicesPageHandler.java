        ...
        if (services != null && services.size() > 0) {
            for (String service : services) {
                ...
                if (providerSize > 0 || consumerSize > 0) {
                    ...
                    row.add(providerSize == 0 ? "<font color=\"red\">No provider</a>" : "<a href=\"providers.html?com.ch.commoninterface.service=" + service + "\">Providers(" + providerSize + ")</a>");
                    row.add(consumerSize == 0 ? "<font color=\"blue\">No consumer</a>" : "<a href=\"consumers.html?com.ch.commoninterface.service=" + service + "\">Consumers(" + consumerSize + ")</a>");
                    row.add("<a href=\"statistics.html?com.ch.commoninterface.service=" + service + "\">Statistics</a>");
                    row.add("<a href=\"charts.html?com.ch.commoninterface.service=" + service + "\">Charts</a>");
                    rows.add(row);
                }
            }
        }
