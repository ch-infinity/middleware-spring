...
public class ChartsPageHandler implements PageHandler {
    ...
    public Page handle(URL url) {
        ...
        nav.append(service);
        nav.append("\">Consumers</a> | <a href=\"statistics.html?com.ch.commoninterface.service=");
        nav.append(service);
        nav.append("&date=");
        nav.append(date);
        nav.append("\">Statistics</a> | Charts &gt; <input type=\"text\" style=\"width: 65px;\" name=\"date\" value=\"");
        nav.append(date);
        nav.append("\" onkeyup=\"if (event.keyCode == 10 || event.keyCode == 13) {window.location.href='charts.html?com.ch.commoninterface.service=");
        nav.append(service);
