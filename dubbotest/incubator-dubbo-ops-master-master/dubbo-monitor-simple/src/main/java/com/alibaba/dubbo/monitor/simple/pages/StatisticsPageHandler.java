...
public class StatisticsPageHandler implements PageHandler {
    ...
    public Page handle(URL url) {
        ...
        if (service == null || service.length() == 0) {
            throw new IllegalArgumentException("Please input com.ch.commoninterface.service parameter.");
        }
        ...
        nav.append(service);
        nav.append(" &gt; <a href=\"providers.html?com.ch.commoninterface.service=");
        nav.append(service);
        nav.append("\">Providers</a> | <a href=\"consumers.html?com.ch.commoninterface.service=");
        nav.append(service);
        nav.append("\">Consumers</a> | Statistics | <a href=\"charts.html?com.ch.commoninterface.service=");
        nav.append(service);
        nav.append("&date=");
        nav.append(date);
        nav.append("\">Charts</a> &gt; <input type=\"text\" style=\"width: 65px;\" name=\"date\" value=\"");
        nav.append(date);
        nav.append("\" onkeyup=\"if (event.keyCode == 10 || event.keyCode == 13) {window.location.href='statistics.html?com.ch.commoninterface.service=");
        nav.append(service);
        ...
        if (!MonitorService.PROVIDER.equals(expand) && !MonitorService.CONSUMER.equals(expand)) {
            ...
            nav.append("<a href=\"statistics.html?com.ch.commoninterface.service=");
            nav.append(service);
            nav.append("&date=");
            nav.append(date);
